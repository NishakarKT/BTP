...
import { CART_ROUTE, HOME_ROUTE, ORDERS_ROUTE, WISHLIST_ROUTE } from "../constants/routes";
...
import { Facebook, LinkedIn, Instagram, AlternateEmail, Home, ShoppingCart, Favorite, FormatListNumbered } from "@mui/icons-material";
        ...
        <Stack component="footer" color="white" bgcolor={mode === "dark" ? "#272727" : "primary.main"} p={2} spacing={2}>
            <Stack direction="row" flexWrap="wrap" justifyContent="space-between">
                <Stack direction="row" alignItems="center">
                    <img style={{ width: "60px", height: "60px" }} src={LOGO_PNG} alt={"logo"} loading="lazy" />
                    <Stack sx={{ userSelect: "none", ml: 1 }}>
                        <Typography variant="h4" align="left">{COMPANY}</Typography>
                        <Typography variant="body1" align="left" gutterBottom>Creativity takes courage!</Typography>
                    </Stack>
                </Stack>
            ...
            <Grid container>
                ...
                <Grid item xs={6} md={3}>
                    <Stack>
                        ...
                        <Stack onClick={() => navigate(WISHLIST_ROUTE)} direction="row" alignItems="center" sx={{ ml: { xs: 0, md: 1 }, p: 1, borderRadius: "5px", cursor: "pointer", transition: "all 0.2s", "&:hover": { backgroundColor: "rgba(0,0,0,0.1)" } }}><Favorite sx={{ mr: 1 }} /><Typography>Wishlist</Typography></Stack>
                        <Stack onClick={() => navigate(CART_ROUTE)} direction="row" alignItems="center" sx={{ ml: { xs: 0, md: 1 }, p: 1, borderRadius: "5px", cursor: "pointer", transition: "all 0.2s", "&:hover": { backgroundColor: "rgba(0,0,0,0.1)" } }}><ShoppingCart sx={{ mr: 1 }} /><Typography>Cart</Typography></Stack>
                        <Stack onClick={() => navigate(ORDERS_ROUTE)} direction="row" alignItems="center" sx={{ ml: { xs: 0, md: 1 }, p: 1, borderRadius: "5px", cursor: "pointer", transition: "all 0.2s", "&:hover": { backgroundColor: "rgba(0,0,0,0.1)" } }}><FormatListNumbered sx={{ mr: 1 }} /><Typography>Orders</Typography></Stack>
                    </Stack>
                </Grid>
                <Grid item xs={6} md={3}>
                    <Stack>
